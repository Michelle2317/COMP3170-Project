                ...
                >
                    ...
                    <Grid item xs={12} sm={4}>
                        ...
                        >
                            ...
                            showcase your favourite recipes, and connect with fellow cooking enthusiasts!
                        </Typography>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={4}>
                        ...
                        >
                            <Grid item xs={6}>
                                {['Home', 'Recipes', 'Top Picks', 'Random Recipes'].map((link, index) => (
                                    <Link
                                        key={index}
                            ...
                            <Grid item xs={6}>
                                {['Add Recipe', 'Profile'].map((link, index) => (
                                    <Link
                                        key={index}
                                        to={`/${link.replace(/\s+/g, '').toLowerCase()}`}
                                        style={{ textDecoration: 'none' }}
